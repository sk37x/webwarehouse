!(function (t, e) {
		...
		Ct = function (t) {
			...
			dt()
				...
				: (((r = document.createElement("div")).className = $.container),
				  ...
				  (r = i),
				  "rtl" === window.getComputedStyle(r).direction && gt(C(), $.rtl),
				  (t = A()),
				  (a = yt(t, $.input)),
				  (e = yt(t, $.file)),
	...
	function At(t, e) {
		...
		i &&
			...
			"string" == typeof (n = e.backdrop)
				...
				: n || gt([document.documentElement, document.body], $["no-backdrop"]),
			!e.backdrop &&
				e.allowOutsideClick &&
				z(
	...
	function Mt(t, e) {
		var o,
			i,
			r,
			n = A().querySelector("#".concat($.content));
		e.html
					...
					: (_t(),
					  e.icon &&
							(-1 !== Object.keys(J).indexOf(e.icon)
								? ((t = k(".".concat($.icon, ".").concat(J[e.icon]))),
								  it(t),
								  Wt(t, e),
								  Ft(t, e),
		...
		for (var e in t)
			te((o = e)) || z('Unknown parameter "'.concat(o, '"')),
				t.toast &&
					((n = e),
					-1 !== se.indexOf(n) &&
						z('The parameter "'.concat(n, '" is incompatible with toasts'))),
				ee((n = e)) && g(n, ee(n));
		var n, o;
	}
	var oe = {},
	...
	var fe = function () {
		...
		he = function (t) {
			...
			return (
				...
				(e === n ||
					!(ct(n) || "INPUT" === e.tagName || (ct(A()) && A().contains(e))))
			);
		},
	...
	function we(t, e, n) {
		var o = C(),
			...
			s = n.willClose,
			n = n.didClose;
		Ce(e, s, r), i ? ke(t, e, o, n || a) : ve(t, o, X(), n || a);
	}
	...
	function Te(t) {
		var e = x();
		t.target === e &&
			((t = C()), e.removeEventListener(Bt, Te), (t.style.overflowY = "auto"));
	}
	function Le(t, e) {
	...
	var Ie = function (t, e) {
		...
		qe = function (t, e) {
			Bt && ut(e)
				? ((t.style.overflowY = "hidden"), e.addEventListener(Bt, Te))
			...
			radio: function (t, e, i) {
				...
				e.forEach(function (t) {
					...
					(o.type = "radio"),
						(o.name = $.radio),
						(o.value = e),
						i.inputValue.toString() === e.toString() && (o.checked = !0);
		...
		Je = function (t, e, n) {
			...
			o.stopKeydownPropagation && e.stopPropagation(),
				"Enter" === e.key
					...
					: "Tab" === e.key
					? Ge(e, o)
					: -1 !== [].concat(Ze, Qe).indexOf(e.key)
					? tn(e.key)
					: -1 !== $e.indexOf(e.key) && en(e, o, n);
		},
		Xe = function (t, e, n) {
			e.isComposing ||
				(e.target &&
			...
			e.container.onmousedown = function () {
				e.popup.onmouseup = function (t) {
					(e.popup.onmouseup = void 0),
						(t.target !== e.popup && !e.popup.contains(t.target)) || (on = !0);
				};
			};
		},
		sn = function (n, o, i) {
	...
	function un(a, s, c) {
		return new Promise(function (t) {
			...
			var n, o, i, r;
			ge.swalPromiseResolve.set(a, t),
				(s.confirmButton.onclick = function () {
					return (
						(e = c),
						(t = a).disableButtons(),
						void (e.input ? ze(t, e, "confirm") : Ye(t, e, !0))
					);
					var t, e;
				}),
				(s.denyButton.onclick = function () {
					return (
						(e = c),
						(t = a).disableButtons(),
						void (e.returnInputValueOnDeny ? ze(t, e, "deny") : Ke(t, e, !1))
					);
					var t, e;
				}),
				...
				(r = s),
				(t = e),
				St.innerParams.get(n).toast ? nn(n, r, t) : (rn(r), an(r), sn(n, r, t)),
				(o = a),
				(r = c),
				(i = e),
				(t = oe).keydownTarget &&
				...
				(c.toast && (c.input || c.footer || c.showCloseButton) ? gt : vt)(
					document.body,
					$["toast-column"]
				),
				(r = a),
	...
	var dn = function (t, e, n) {
		...
		pn = function (t, e) {
			if (!e.toast)
				return Y(e.allowEnterKey) ? void (fn(t, e) || De(0, -1, 1)) : mn();
		},
		fn = function (t, e) {
	...
	c(bn.prototype, Q),
		...
		Object.keys(Q).forEach(function (t) {
			bn[t] = function () {
				if (vn) return vn[t].apply(vn, arguments);
			};
		}),
		(bn.DismissReason = Z),
		(bn.version = "10.8.1");
